...
import GenerateRoadmapCTA from "./GenerateRoadmapCTA";
...
export default function Hero() {
  return (
    <section className="my-container mt-5 space-y-2 flex items-center">
      <div>
        {" "}
        <Subheading content="AI Powered Learning" />
        ...
        <p className="max-w-xl mt-20">
          Generate custom learning paths powered by AI. Get instant guidance
          from our intelligent chatbot and master any programming skill with
          confidence.
        </p>
