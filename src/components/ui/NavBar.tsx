...
export default function NavBar() {
  ...
  if (isMobile) {
    return (
      <nav
        className={`h-16 shadow-sm z-50 relative w-full flex justify-between items-center px-4  py-2  mx-auto bg-background border border-b-border`}
      >
        <Link href="/">
          <Image
            src={Logo}
  ...
  // Desktop layout
  return (
    <nav className={`sticky top-0 z-50 h-[74px] hidden lg:block bg-background border border-b-border`}>
